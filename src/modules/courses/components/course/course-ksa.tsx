...
export function CourseKsa({ coursePoints }: CourseKsaProps) {
  ...
  return (
    <AccordionItem value="course-ksa" className="rounded-lg border border-border bg-secondary/30 backdrop-blur-sm">
